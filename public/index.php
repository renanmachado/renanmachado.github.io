...
<meta name="theme-color" content="#ffffff">
  ...
  <link rel="stylesheet" href="/public/css/simplebar.min.css">
  <link rel="stylesheet" href="/public/css/jquery.mb.YTPlayer.min.css">
  <!-- Main CSS-->
  <link rel="stylesheet" href="/public/css/main.css">
  <!-- CSS Color scheme-->
  <link id="color-scheme" rel="stylesheet" href="/public/css/colors/main-cyan.css">
...
<body class="theme-dark">
  ...
  <nav class="navbar-expand-md navbar fixed-top" id="navbar"><a class="navbar-brand" data-scroll="" href="#home-area">
      <!-- Navbar Logo-->
      <img class="img-fluid" src="/public/img/blank-logo.png" alt="Logo"></a>
          ...
          <div class="lightbox-content">
            ...
            <div class="info-section single-section">
              <div class="row align-items-center">
                <!-- Picture part-->
                <div class="col-12 col-lg-5 info-img"><img class="img-fluid img-thumbnail" src="/public/img/renan-perfil.jpg" alt="About Picture"></div>
                <!-- Content part-->
  ...
  <script src="/public/js/animatedModal.js"></script>
